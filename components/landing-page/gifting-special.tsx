    ...
    return (
        <section className="relative bg-[#1D453A]">
            <img
                ...
                aria-hidden
            />
            <div className="mx-auto flex w-full max-w-[1320px] flex-col items-center justify-center gap-8 px-3 py-8 sm:px-4 sm:py-11 md:px-6 lg:flex-row lg:gap-10 lg:px-8 lg:py-14 xl:px-10">
