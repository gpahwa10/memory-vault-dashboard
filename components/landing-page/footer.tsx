            ...
            <div className="flex flex-col gap-10 lg:flex-row lg:items-start lg:justify-between lg:gap-8 xl:gap-12">
                <div className="flex min-w-0 flex-col gap-4">
                    <div className="flex min-w-0 items-center gap-2 sm:gap-[8px]">
                        ...
                        />
                        <h1 className={`${gtSuperDisplay.className} truncate font-400 text-white text-lg sm:text-xl lg:text-[1.65rem]`}>
                            Memory Vault
                        </h1>
                    </div>
                    <p className={`${jost.className} text-sm font-400 text-white sm:text-base lg:text-lg`}>© 2026 Memory Vault. All rights <br /> reserved.</p>
                </div>
                ...
                <div className="grid flex-1 grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-3 lg:gap-8">
                    ...
                    <div className="flex flex-col gap-4">
                        <h2 className={`${gtSuperDisplay.className} text-xl font-400 text-[#CAA64A] sm:text-2xl`}>Social Media</h2>
                    ...
                    <div className="flex flex-col gap-4 sm:col-span-2 lg:col-span-1">
                        <h2 className={`${gtSuperDisplay.className} text-xl font-400 text-[#CAA64A] sm:text-2xl`}>Contact info</h2>
                        <div className={`${jost.className} flex gap-3 text-sm font-400 text-white sm:text-base lg:text-lg`}>
